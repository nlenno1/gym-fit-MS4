...
All the CSS files on the project were validated using [The W3C CSS Validation Service](https://jigsaw.w3.org/css-validator/). They were tested through direct input top remove the errors and warnings generated by external files.
...
During development I had [pylint](https://pylint.org/) installed on my workspace which highlighted any problems which were correct as and when they arose.

I also used the [Black Code Formatter](https://black.readthedocs.io/en/stable/) to format and beautify the code. 

Using the flake8 display error function:
...
./checkout/models.py:5:1: F401 'django.conf.settings' imported but unused| Flake8 doesn't have access to see the use|
|./checkout/apps.py:9:9: F401 'checkout.signals' imported but unused
...
./gym_fit/settings.py:164:80: E501 line too long (83 > 79 characters) | Breaking these lines stop break the function |
