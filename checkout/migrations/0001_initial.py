    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access_package', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='products.classaccesspackage')),
                ('exercise_class', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='classes.singleexerciseclass')),
